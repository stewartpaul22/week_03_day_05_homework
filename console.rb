...
#<editor-fold> Tickets
ticket1 = Ticket.new({ 'customer_id' => customer1.id, 'movie_id' => movie1.id, 'screening_id' => screening1.id })
ticket2 = Ticket.new({ 'customer_id' => customer1.id, 'movie_id' => movie2.id, 'screening_id' => screening5.id })
ticket3 = Ticket.new({ 'customer_id' => customer1.id, 'movie_id' => movie3.id, 'screening_id' => screening9.id })
ticket4 = Ticket.new({ 'customer_id' => customer2.id, 'movie_id' => movie1.id, 'screening_id' => screening1.id })
ticket5 = Ticket.new({ 'customer_id' => customer2.id, 'movie_id' => movie5.id, 'screening_id' => screening17.id })
ticket6 = Ticket.new({ 'customer_id' => customer3.id, 'movie_id' => movie1.id, 'screening_id' => screening1.id })
ticket7 = Ticket.new({ 'customer_id' => customer3.id, 'movie_id' => movie6.id, 'screening_id' => screening24.id })
ticket8 = Ticket.new({ 'customer_id' => customer4.id, 'movie_id' => movie1.id, 'screening_id' => screening4.id })
ticket9 = Ticket.new({ 'customer_id' => customer4.id, 'movie_id' => movie4.id, 'screening_id' => screening15.id })
ticket1.save()
ticket2.save()
ticket3.save()
ticket4.save()
